const words = [
    ...
    new Word(['romantic'], 'You are in a romance whit a person'),
    new Word(['family'], 'You are related to this person by blood or marriage'),
    new Word(['friend'], 'You enjoy spending time with this person'),
    new Word(['co-worker'], 'you work together in the same company'),
    new Word(['long', 'distance'], 'You hardly ever see this person because he/she is so far. It\'s a kind a of relationship'),
    new Word(['acquaintance'], 'You don\'t have any shared experiences or connections with this person. It\'s a kind a of relationship'),
